...
import { ArrowRight, Clock, Users, MessageSquare, Calendar, Smartphone, DollarSign } from 'lucide-react';
            ...
            <div>
              ...
              <div className="space-y-6 mb-8">
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h4 className="font-semibold text-gray-900 mb-2">Manage Your Properties</h4>
                    <p className="text-gray-600">Handle your property listings from one mobile dashboard.</p>
                  </div>
                </div>
              </div>
            </div>
                ...
                <div className="bg-gray-900 rounded-[2.5rem] p-2 shadow-2xl">
                  <div className="bg-white rounded-[2rem] overflow-hidden">
                    <div className="bg-gradient-to-r from-orange-500 to-orange-600 p-4 text-white text-center">
                      ...
                      <p className="text-sm text-orange-100">Active listing</p>
                    </div>
